...
export const metadata: Metadata = {
  title: "Santosh Group of Institutions | Bangarpet & Bangalore",
  description:
    "34+ years of academic heritage. Pre-Primary to Graduation across 11 institutions. Affiliated to Bangalore University, Karnataka State PU Board & NCTE.",
};
